...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: C.white, borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, borderWidth: 1, borderColor: C.borderLight, fontSize: 16, color: C.text },
  forgotBtn: { alignSelf: "flex-end" },
  forgotText: { color: C.primary, fontWeight: "600", fontSize: 14 },
  loginBtn: { backgroundColor: C.primary, borderRadius: 14, paddingVertical: 16, alignItems: "center", marginTop: 10 },
  loginBtnText: { color: C.white, fontSize: 16, fontWeight: "700" },
  footer: { flexDirection: "row", justifyContent: "center", gap: